...
//                String sourceNamePatient = scanner.next();
//                System.out.print("Enter the path for the Appointment repository file: ");
//                String sourceNameAppointment = scanner.next();
//                PatientRepo = new PatientFileRepository(sourceNamePatient);
//                AppRepo = new AppointmentFileRepository(sourceNameAppointment);
//                break;
//            case "binaryFile":
//                System.out.print("Enter the path for the Patient repository file: ");
//                String binarySourceNamePatient = scanner.next();
//                System.out.print("Enter the path for the Appointment repository file: ");
//                String binarySourceNameAppointment = scanner.next();
//                PatientRepo = new PatientBinaryFileRepository(binarySourceNamePatient);
//                AppRepo = new AppointmentBinaryFileRepository(binarySourceNameAppointment);
//                break;
//            default:
...
//#########################
     //   Service service = new Service(PatientRepo, AppRepo);
        //Service service = new Service(PatientRepo.toString(), AppRepo.toString());
