...
BigInteger::BigInteger(const BigInteger& N) //copy constructor for the digits
{
...
BigInteger& BigInteger::operator++()	//pre-increment overload
{
...
BigInteger BigInteger::abs() const  //the absolute value
{
